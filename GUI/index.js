...
async function init(express, db, _settings) {
	...
	await GUI.listen(settings.GUI.port);
	console.log("LOGS-THREAD GUI running at localhost:" + settings.GUI.port);
}
